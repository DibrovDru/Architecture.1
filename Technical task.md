...
•       Дата начала (обязательное поле для заполнения). Дата окончания высчитывается автоматически в зависимости от длительности(отображать при создании спринта нет необходимости);
...
Далее спринт должн отображаться в соответствующем разделе по статусу.
