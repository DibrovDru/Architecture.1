...
### [Создание сотрудника](#раздел-сотрудники)



### [Создание задачи](#раздел-задачи)
...
**Отобразить кнопку "Авторизация"**, для прохождения авторизации, в случае успешной регистрации или для возврата назад.
