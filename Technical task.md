...
![Схема](https://github.com/DibrovDru/Architecture.1/raw/dev_muratov/images/CreateEmployee1.PNG)

### [Создание задачи](#раздел-задачи)

### [Создание отчета](#раздел-отчеты)
...
Отобразить кнопку при выборе спринтов "Добавить спринт".
