...
На главной странице должна отображаться информация об авторизации с формой входа.

Пользователю необходимо указывать логин и пароль для входа
...
•	cтатус отчета доступен для просмотра только Тимлиду.
...
•	lля тимлида реализовать возможность у отчетов со статусом «завершен» агрегировать общий(командный отчет)
