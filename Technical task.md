...
На странице должна быть реализована возможность *Создания проекта.*
...
• Добавить сотруднико в(поле является не обязательным для заполнения). 
...
*Если поле "Добавить сотрудников" не было заполнено, то пользователь не переходит на 3 этап, а создание проекта завершается и проект сохраняется.*
...
*Создание задачи не возможно при отсутствии спринтов. Необходимо пользователю вывести информацию о необходимости [создания спринта](#cоздание-спринта) и открыть страницу для его создания.*
...
• "три точки", далее отобразить скопки "Дублировать" и "Удалить".
