...
## Дизайн
Полноцветный дизайн для требуемых разрешений экранов в соответствии с разработанной структурой и логикой, а также стилевыми пожеланиями Заказчика расположен по адресу: 
